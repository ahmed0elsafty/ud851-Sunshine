...
public class SunshinePreferences {
    ...
    public static boolean isMetric(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String tempUnit = sharedPreferences.getString(context.getString(R.string.pref_units_key), context.getString(R.string.pref_units_metric));
        if (!tempUnit.equals(context.getString(R.string.pref_units_metric))) {
            return false;
        } else {
            /** This will be implemented in a future lesson **/
            return true;
