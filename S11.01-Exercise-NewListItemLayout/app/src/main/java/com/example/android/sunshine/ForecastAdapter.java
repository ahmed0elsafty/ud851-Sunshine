...
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        int weatherStateImg = SunshineWeatherUtils.getSmallArtResourceIdForWeatherCondition(weatherId);
        forecastAdapterViewHolder.ivWeatherState.setImageResource(weatherStateImg);

        forecastAdapterViewHolder.ivWeatherState.setImageResource(weatherStateImg);
        forecastAdapterViewHolder.tvWeatherState.setText(description);
        forecastAdapterViewHolder.tvWeatherDate.setText(dateString);
        forecastAdapterViewHolder.tvMaxTemp.setText(highTemperature);
        forecastAdapterViewHolder.tvMinTemp.setText(lowTemperature);
    }
    ...
    class ForecastAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        TextView tvWeatherState,tvWeatherDate,tvMinTemp,tvMaxTemp;

        ImageView ivWeatherState;

        ForecastAdapterViewHolder(View view) {
            super(view);
            ivWeatherState = view.findViewById(R.id.iv_weather_state);
            tvWeatherState = view.findViewById(R.id.tv_weather_state);
