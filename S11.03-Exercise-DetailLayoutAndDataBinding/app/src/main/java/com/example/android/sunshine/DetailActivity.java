...
public class DetailActivity extends AppCompatActivity implements
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        mDetailBinding.primaryWeatherInfo.weatherIcon.setImageResource(imageId);
        ...
        String descAlly = getString(R.string.a11y_forecast,description);
        /* Set the text to display the description*/
        mDetailBinding.primaryWeatherInfo.weatherDescription.setText(description);
        mDetailBinding.primaryWeatherInfo.weatherDescription.setContentDescription(descAlly);

        mDetailBinding.primaryWeatherInfo.weatherIcon.setContentDescription(descAlly);
        ...
        mDetailBinding.primaryWeatherInfo.highTemperature.setContentDescription(highTempAlly);
        ...
        mDetailBinding.extraWeatherInfo.humidityValue.setContentDescription(humidityAlly);
        mDetailBinding.extraWeatherInfo.humidity.setContentDescription(humidityAlly);
        mDetailBinding.extraWeatherInfo.humidityValue.setText(humidityString);
        ...
        mDetailBinding.extraWeatherInfo.windValue.setText(windString);
        mDetailBinding.extraWeatherInfo.wind.setContentDescription(windAlly);
        mDetailBinding.extraWeatherInfo.windValue.setContentDescription(windAlly);
        ...
        mDetailBinding.extraWeatherInfo.pressureValue.setText(pressureString);
        mDetailBinding.extraWeatherInfo.pressureValue.setContentDescription(pressureAlly);
        mDetailBinding.extraWeatherInfo.pressure.setContentDescription(pressureAlly);
